...
function initialize(products) {
  ...
  // fetchBlob uses fetch to retrieve the image
  function fetchBlob(product) {
    // construct the URL path to the image file from the product.image property
    const url = `res/images/${product.image}`;
  ...
  function showProduct(blob, product) {
    ...
    // Give the <p> textContent equal to the product "calories" property, with a $ sign in front

    para.textContent = `${product.calories}cals`;
